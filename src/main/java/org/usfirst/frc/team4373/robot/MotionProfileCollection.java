...
public class MotionProfileCollection implements
        Map<String, MotionProfileTuple> {

    private HashMap<String, MotionProfileTuple> keyRecordMapping;
    ...
    public MotionProfileCollection(String[] names, MotionProfileTuple[] profiles)
        ...
        if (names.length != profiles.length) {
            throw new IllegalArgumentException("Keys do not match values");
        }
        for (int i = 0; i < names.length; ++i) {
            this.keyRecordMapping.put(names[i], profiles[i]);
        }
    }

    public MotionProfileCollection(ArrayList<String> names, ArrayList<MotionProfileTuple> profiles)
            throws IllegalArgumentException {
        if (names.size() != profiles.size()) {
            throw new IllegalArgumentException("Keys do not match values");
        }
        for (int i = 0; i < names.size(); ++i) {
            this.keyRecordMapping.put(names.get(i), profiles.get(i));
        }
    }
    ...
    @Override
    public int size() {
        return this.keyRecordMapping.size();
    }
    ...
    public boolean isEmpty() {
        return this.keyRecordMapping.isEmpty();
    }
    ...
    public boolean containsKey(Object key) throws
        ...
        return this.keyRecordMapping.containsKey(key);
    }
    ...
    public boolean containsValue(Object value) throws
            ClassCastException, NullPointerException {
        return this.keyRecordMapping.containsValue(value);
    }
     ...
     */
    @Override
    public MotionProfileTuple get(Object key) throws
            ClassCastException, NullPointerException {
        return this.keyRecordMapping.get(key);
    }
     ...
     */
    @Override
    public MotionProfileTuple put(String key, MotionProfileTuple value) throws
            UnsupportedOperationException, ClassCastException,
            NullPointerException, IllegalArgumentException {
        return this.keyRecordMapping.put(key, value);
    }
     ...
     */
    @Override
    public MotionProfileTuple remove(Object key) throws UnsupportedOperationException,
            ClassCastException, NullPointerException {
        return this.keyRecordMapping.remove(key);
    }
     ...
     */
    @Override
    public void putAll(Map<? extends String, ? extends MotionProfileTuple> m) throws UnsupportedOperationException,
            ClassCastException, NullPointerException, IllegalArgumentException {
        this.keyRecordMapping.putAll(m);
    }
    ...
    public Set<String> keySet() {
        return this.keyRecordMapping.keySet();
    }
     ...
     */
    @Override
    public Collection<MotionProfileTuple> values() {
        return this.keyRecordMapping.values();
    }
     ...
     */
    @Override
    public Set<Entry<String, MotionProfileTuple>> entrySet() {
        return this.keyRecordMapping.entrySet();
    }
}
